...
[@fig:shrike-pinout]と [@fig:shrike-pmod-pinout]にピン配置を示します。

![ピン配置](images/pinout.png){width=150mm #fig:shrike-pinout}

\newpage

![PMODピン配置](images/pinout_pmod.png){width=150mm #fig:shrike-pmod-pinout}
...
- ピン配置図生成には[Pinout Leaf Generator](https://github.com/marcteale/pinoutleaf?tab=readme-ov-file#pinout-leaf-generator-)
  を使いました。SVG-PNG変換はネットで見つけたツール<https://amamamaou.github.io/svg2png/>を使用しました。
